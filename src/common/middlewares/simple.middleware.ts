...
export class SimpleMiddleware implements NestMiddleware {
    use(req: Request, res: Response, next: NextFunction) {
        ...
        console.log('SimpleMiddleware: Tchau'); // se tiver mais de um middleware, o next() chama o próximo middleware e depois esse console.log

        res.on('finish', () => {
            console.log('SimpleMiddleware: Conexão encerrada');
        });
    }
}           